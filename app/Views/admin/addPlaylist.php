...
<main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
    ...
    <div class="form-container flex justify-center items-center h-screen">
        <form method="post" enctype="multipart/form-data" class="bg-white w-full max-w-md p-8 rounded-xl shadow-xl">
            <div class="mb-4">
                <label for="playlistName" class="block text-gray-700 text-sm font-semibold mb-2">Playlist Name</label>
                <input id="playlistName" name="playlistName" type="text" placeholder="Enter the name of the playlist" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500">
            </div>

            <div class="mb-4">
                <label for="playlistDescription" class="block text-gray-700 text-sm font-semibold mb-2">Playlist Description</label>
                <input id="playlistDescription" name="playlistDescription" type="text" placeholder="Enter the description of the playlist" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500">
            </div>

            <div class="mb-4">
                <label for="playlistImage" class="block text-gray-700 text-sm font-semibold mb-2">Playlist Image</label>
                <input id="playlistImage" name="playlistImage" type="file" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500">
            </div>

            <button type="submit" name="addplaylist" class="w-full bg-blue-500 text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue active:bg-blue-800">
                Add Playlist
            </button>
        </form>
    </div>
