...
<main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-50 min-h-screen transition-all main">
    ...
    <div class="form-container flex justify-center items-center h-screen">
        ...
        <h2 class="text-center font-bold text-2xl mb-12">Add New Style</h2>
            <div class="mb-4">
                <label for="playlistName" class="block text-gray-700 text-sm font-semibold mb-2">Style Name</label>
                <input id="playlistName" name="styleName" type="text" placeholder="Enter the name of the playlist" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-blue-500">
            </div>
            <button type="submit" name="addStyle" class="w-full bg-blue-500 text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-600 focus:outline-none focus:shadow-outline-blue active:bg-blue-800">
                Add Style
            </button>
        </form>
    </div>
