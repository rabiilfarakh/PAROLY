        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
            <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                <div class="flex justify-center mb-6">
                    <div>
                        <div class="text-2xl font-semibold mb-1"><?=$data[0]["artistCount"];?></div>
                        <div class="text-sm font-medium text-gray-400">Artists</div>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                <div class="flex justify-center mb-4">
                    <div>
                        <div class="flex items-center mb-1">
                            <div class="text-2xl font-semibold"><?= $data[0]["playlistCount"] ?></div>
                        </div>
                        <div class="text-sm font-medium text-gray-400">playlists</div>
                    </div>
                </div>
            </div>
            <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                <div class="flex justify-center mb-6">
                    <div>
                        <div class="text-2xl font-semibold mb-1"><span
                                    class="text-base font-normal text-gray-400 align-top"></span><?= $data[0]["styleCount"] ?>
                        </div>
                        <div class="text-sm font-medium text-gray-400">Styles</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="flex justify-between mb-4 items-start">
                    ...
                    <div class="flex gap-4">
                        <div class="addPlaylist">
                            <a href="Playlists/addPlaylist" class="bg-blue-700 text-white rounded-lg p-2 font-medium">Add
                                Playlist</a>
                        </div>
                        <div class="dropdown">
                            ...
                            <tr>
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <div class="flex items-center">
                                        <img src="data:image/jpg;charset=utf8;base64,<?= base64_encode($item['playlistImage']) ?>"
                                             alt=""
                                ...
                                <td class="py-2 px-4 border-b border-b-gray-50">
                                    <div class="flex items-center">
                                        <img src="https://placehold.co/32x32" alt=""
                                             class="w-8 h-8 rounded object-cover block">
                                        <a href="#"
                                           class="text-gray-600 text-sm font-medium hover:text-blue-500 ml-2 truncate"><?= $item["styleName"] ?></a>
                                    </div>
                                </td>
                                <td class="py-2 px-4 border-b border-b-gray-50">
